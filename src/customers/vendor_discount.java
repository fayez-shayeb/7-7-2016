 ...
 * @author Fayez_shayeb
 */
public class vendor_discount extends javax.swing.JFrame {
     ...
     */
    public vendor_discount(customers obj,String discount_id_1,int new_modify) {
        customer_obj=obj;
        ...
        try { 
            ...
            jComboBox4.setSelectedItem(obj.jComboBox_ven_name_for_account_details.getSelectedItem());
        } catch (SQLException ex) {
            //Logger.getLogger(modify_customer_payment.class.getName()).log(Level.SEVERE, null, ex);
            Joptionpane_message(ex.getMessage()); 
        }
    }
      public vendor_discount(customers obj) {
          customer_obj=obj;
        initComponents();
        r = conn_obj.conn_exec("select vendor_name from vendors order by vendor_name ");
        try { 
...
if(new_or_modify==0){
        try {
            ...
            stm = "INSERT INTO vendor_discount (discount_value,vendor_id_fk,discount_maker,discount_date,discount_note) VALUES("+value+","+vendor_id+","+1+",'"+sqlDate+"','"+note+"');";
            ...
            if(jLabel52.getIcon()!= null)//صورة الدفعة النقدية
            {
                ...
                customer_obj.show_last_row_scroll_jtable(customer_obj.jTable_show_ven_account_details);

                //customer_obj.create_vendor_account_table();
                ...
                try {
                    ...
                    //Logger.getLogger(vendors.class.getName()).log(Level.SEVERE, null, ex1);
                }
    ...
    try {
            ...
            String stm="";
            conn_obj.exec("DELETE FROM vendor_discount where discount_id="+discount_id+"");
            
            stm = "INSERT INTO vendor_discount (discount_value,vendor_id_fk,discount_maker,discount_date,discount_note,discount_id) VALUES("+value+","+vendor_id+","+1+",'"+sqlDate+"','"+note+"',"+discount_id+");";
...
jButton5.doClick();        // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(vendor_discount.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
