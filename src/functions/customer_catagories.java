 ...
 * @author Fayez
 */
public class customer_catagories extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        try{
            r = conn_obj.conn_exec("select catagory_id as ID,catagory_name As Name from customer_catagory");
        }catch(Exception e){
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        r = conn_obj.conn_exec("select * from customer_catagory where catagory_id=" + x + "");
        try {
            r.next();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String stm = "insert into customer_catagory (catagory_name)values('" + name + "')";
        try {
            ...
            if (!name.equals("")) {
                {
                    conn_obj.exec(stm);
                    Joptionpane_message("تمت إضافة التصنيف");
                    r = conn_obj.conn_exec("select catagory_id as ID,catagory_name As Name from customer_catagory");
            jTable1.setModel(DbUtils.resultSetToTableModel(r));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(customer_catagories.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new customer_catagories().setVisible(true);
            }
        });
    }
 ...
 public void delete_name() throws SQLException, Exception {
        ...
        try {
            if (jTable1.getValueAt(jTable1.getSelectedRow(), 1).equals("------")) {
                throw new Exception("خطأ في اختيار التصنيف !!!!");
            }
            conn_obj.get_con().setAutoCommit(false);
            conn_obj.get_st().execute("delete from customer_catagory where catagory_id =" + jTable1.getValueAt(jTable1.getSelectedRow(), 0) + "");
            Joptionpane_confirm("هل انت متأكد من حذف التصنيف", "لم يتم حذف التصنيف");
...
private void update_button() {
        ...
        try {
            ...
            if(!name.equals(""))
            {
                conn_obj.get_st().executeUpdate("UPDATE customer_catagory SET catagory_name='" + name + "' where catagory_id=" + id + ";");
                r = conn_obj.conn_exec("select catagory_id as ID,catagory_name As Name from customer_catagory");
            jTable1.setModel(DbUtils.resultSetToTableModel(r));
            /////
            jTextField8.setText("");
